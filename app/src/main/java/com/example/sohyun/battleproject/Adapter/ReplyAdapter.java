...
public class ReplyAdapter extends BaseAdapter {
    ...
    public ReplyAdapter(Activity context, List<ReplyData> chatMessages) {
        this.context = context;
        this.replyMessages = chatMessages;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        ReplyData replyMessages = getItem(position);
        ...
        boolean myMsg = replyMessages.isME;//Just a dummy check
        //to simulate whether it me or other sender
        setAlignment(holder, myMsg);
        holder.txtMessage.setText(replyMessages.content);
        holder.txtInfo.setText(replyMessages.reg_date);
